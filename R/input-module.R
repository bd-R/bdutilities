...
#'
#' Use \code{dataInputModuleInput} to add server funtionality
#'
#' @param id the unique id to be identified in the namespace. Refer shiny modules for more details.
#'
#' @return Shiny UI elements in a column of size 12.
#'
#' @examples
#' 
#' # For UI
#' dataInputModuleInput("bdFileInput")
#' 
#' # For Server
#' reactive_dataframe <- callModule(dataInputModule, "bdFileInput")
#' 
#' # Converting reactive element to dataframe
#' bd_data <<- reactive_dataframe()
#'
#' @export
dataInputModuleInput <- function(id) {
...
#'
#' Use \code{dataInputModuleInput} to add UI funtionality
#'
#' @param input the input elements.
#' @param output the output elements.
#' @param session the session elements.
#'
#' @return reactive element with dataframe data retrieved with UI elements
#'
#' @examples
#' 
#' # For UI
